pipeline {
  ...
  environment {
      ...
      terraform = 'docker run -e "ARM_SUBSCRIPTION_ID=175f0376-6221-48ff-947b-37005e74e5df" -e "ARM_TENANT_ID=a9399ad9-9fae-4cec-8be1-f084721150cd" -e "ARM_CLIENT_ID=4c67f96e-d383-46c3-8c07-b9837c3fa0f9" -e "ARM_CLIENT_SECRET=f213c981-95e5-4406-bb67-cc18b09ae5bf" -v /var/lib/jenkins/workspace/TerraformAzure:/var/lib/jenkins/workspace/TerraformAzure:rw,z -w /app -v /var/lib/jenkins/workspace/TerraformAzure:/app hashicorp/terraform:light'
  }
  stages {
